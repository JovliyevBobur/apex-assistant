...
const ConversationSidebar = ({
  ...
  const deleteAllConversations = async () => {
    ...
    if (error) {
      toast.error("Suhbatlarni o'chirishda xatolik");
      return;
    }
        ...
        <div className="flex flex-col h-full p-4">
          ...
          {conversations.length > 1 && (
            <Button
              ...
              variant="ghost"
              size="sm"
              className="w-full mb-3 text-muted-foreground hover:text-destructive"
            >
                      ...
                      {deletingId === conversation.id ? (
                        <>
                          <button
                            ...
                            className="p-1.5 bg-destructive/20 text-destructive rounded transition-all"
                            title="Tasdiqlash"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 hover:bg-muted rounded transition-all"
                            title="Bekor qilish"
                          >
                            <X className="w-4 h-4" />
                          </button>
